...
public:
	...
	bool ListActM(char str[STR_LENGTH]);
	bool ListPasvM(char str[STR_LENGTH]);
	bool Ls();
	bool Dir();
	bool Put(char src_filename[STR_LENGTH]=NULL, char des_filename[STR_LENGTH]=NULL);
	bool Get(char src_filename[STR_LENGTH]=NULL, char des_filename[STR_LENGTH]=NULL);
...
private:
	bool SendCommand();
	bool dataTransfActM(bool stream);
	bool dataTransfPasvM(bool stream);
